            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="card-content table-responsive">
                        ...
                        <a href="<?=base_url("Teacher/dl_excel/")?><?=$_SESSION['uid']?>/<?=$date_value?>" class="btn btn-success mb-3"><i class="fa-solid fa-file-excel"></i> Export data for(<?=($date_value)?>)</a>
                        </div>
                        <table class="table">
                            <thead class="fw-bold">
                                <tr>
