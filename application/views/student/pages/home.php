...
<?php else:?>
   <div class="card rounded p-2">
      <div class="container p-5">
         <div class="text-center fs-4">Currently not Applied to a Subject.</div>
      </div>
   </div>
<?php endif;?>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
               ...
               <a href="<?=site_url('Student_edit')?>"type="button" class="btn btn-primary">Go to Edit Profile Settings</a>
            </div>
