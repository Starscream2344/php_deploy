...
class Teacher extends CI_Controller
{
    ...
    public function index()
    {
		...
		$validate = $this->User->get_user($this->session->userdata['uid']);
	...
	public function delete_attendance($subjectID,$sectionID,$attendanceID)
	{
		$this->check_session();
		$this->load->model('Attendance');
		...
		$this->view_attendance($subjectID,$sectionID);
	}
